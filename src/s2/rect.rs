...
mod tests {
    ...
    fn test_rect_centroid_splitting(r: Rect, splits_left: i32) {
        ...
        if random::one_in(&mut rng, 2) {
            ...
            let lat = rng.random_range(lat_lo..lat_hi);
            child0 = Rect {
            ...
            let lng = rng.random_range(lng_lo..lng_hi);
            child0 = Rect {
                lat: r.lat,
                lng: Interval {
                    lo: r.lng.lo,
    ...
    fn test_rect_centroid_full_range() {
        ...
        for _ in 0..100 {
            let lat1 = rng.random_range(-FRAC_PI_2..FRAC_PI_2);
            let lat2 = rng.random_range(-FRAC_PI_2..FRAC_PI_2);
            let r = Rect {
        ...
        for _ in 0..100 {
            let lng1 = rng.random_range(-PI..PI);
            let lng2 = rng.random_range(-PI..PI);
            let r = Rect {
                lat: VALID_RECT_LAT_RANGE,
